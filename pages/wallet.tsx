    ...
    <div>
      <div className=" my-9 flex flex-col justify-center items-center">
        ...
        <div className="w-6/12 flex space-x-5 my-5 flex-row items-center justify-between">
          <div className="uppercase  rounded-md text-center py-2 px-5 text-white text-lg w-full cursor-default bg-gradient-to-r from-blue-500 to-blue-900 ">
            TRANSFER
          </div>
          <div className="uppercase  rounded-md text-center py-2 px-5 text-white text-lg w-full cursor-default bg-gradient-to-r from-blue-600 to-pink-600 ">
            WITHDRAW
          </div>
        </div>
      </div>
